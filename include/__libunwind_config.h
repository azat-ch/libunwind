...
/// size of 8 byte words
/// 56 - CIE_Info
/// 48 - FDE_Info
#    define _LIBUNWIND_CIE_SIZE (56/8)
#    define _LIBUNWIND_FDE_SIZE (48/8)
#    define _LIBUNWIND_CURSOR_SIZE (33+45*(2+_LIBUNWIND_CIE_SIZE+_LIBUNWIND_FDE_SIZE)+4)
#  endif
